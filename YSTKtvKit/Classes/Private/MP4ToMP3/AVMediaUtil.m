...
#pragma mark - 暴露方法
//转换从路径
+ (void)changeVideoToAudioWithReadPath:(NSURL *)readPath name:(NSString *)fileName completionHandler:(void(^)(successType success , NSString *fileName))completionHandler
{
    //判断读取路径是否存在
    if (readPath == nil)
    {
